...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabXXI = localStorage.getItem("lastTabXXI");
		if (lastTabXXI) {
			switch (lastTabXXI) {
				case "Cover":
					localStorage.setItem("coverTabXXIIsActive", true);
					localStorage.setItem("authorTabXXIIsActive", false);
					localStorage.setItem("dedTabXXIIsActive", false);
					localStorage.setItem("chapterTabXXIIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabXXIIsActive", false);
					localStorage.setItem("authorTabXXIIsActive", true);
					localStorage.setItem("dedTabXXIIsActive", false);
					localStorage.setItem("chapterTabXXIIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabXXIIsActive", false);
					localStorage.setItem("authorTabXXIIsActive", false);
					localStorage.setItem("dedTabXXIIsActive", true);
					localStorage.setItem("chapterTabXXIIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabXXIIsActive", false);
					localStorage.setItem("dedTabXXIIsActive", false);
					localStorage.setItem("chapterTabXXIIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabXXI = localStorage.setItem("lastTabXXI", "Cover");
			localStorage.setItem("coverTabXXIIsActive", true);
			localStorage.setItem("authorTabXXIIsActive", false);
			localStorage.setItem("dedTabXXIIsActive", false);
			localStorage.setItem("chapterTabXXIIsActive", false);
