...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTab1965 = localStorage.getItem("lastTab1965");
		if (lastTab1965) {
			switch (lastTab1965) {
				case "Cover":
					localStorage.setItem("coverTab1965IsActive", true);
					localStorage.setItem("authorTab1965IsActive", false);
					localStorage.setItem("dedTab1965IsActive", false);
					localStorage.setItem("chapterTab1965IsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTab1965IsActive", false);
					localStorage.setItem("authorTab1965IsActive", true);
					localStorage.setItem("dedTab1965IsActive", false);
					localStorage.setItem("chapterTab1965IsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTab1965IsActive", false);
					localStorage.setItem("authorTab1965IsActive", false);
					localStorage.setItem("dedTab1965IsActive", true);
					localStorage.setItem("chapterTab1965IsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTab1965IsActive", false);
					localStorage.setItem("dedTab1965IsActive", false);
					localStorage.setItem("chapterTab1965IsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTab1965 = localStorage.setItem("lastTab1965", "Cover");
			localStorage.setItem("coverTab1965IsActive", true);
			localStorage.setItem("authorTab1965IsActive", false);
			localStorage.setItem("dedTab1965IsActive", false);
			localStorage.setItem("chapterTab1965IsActive", false);
