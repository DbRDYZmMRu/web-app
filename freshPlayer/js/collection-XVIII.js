...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabXVIII = localStorage.getItem("lastTabXVIII");
		if (lastTabXVIII) {
			switch (lastTabXVIII) {
				case "Cover":
					localStorage.setItem("coverTabXVIIIIsActive", true);
					localStorage.setItem("authorTabXVIIIIsActive", false);
					localStorage.setItem("dedTabXVIIIIsActive", false);
					localStorage.setItem("chapterTabXVIIIIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabXVIIIIsActive", false);
					localStorage.setItem("authorTabXVIIIIsActive", true);
					localStorage.setItem("dedTabXVIIIIsActive", false);
					localStorage.setItem("chapterTabXVIIIIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabXVIIIIsActive", false);
					localStorage.setItem("authorTabXVIIIIsActive", false);
					localStorage.setItem("dedTabXVIIIIsActive", true);
					localStorage.setItem("chapterTabXVIIIIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabXVIIIIsActive", false);
					localStorage.setItem("dedTabXVIIIIsActive", false);
					localStorage.setItem("chapterTabXVIIIIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabXVIII = localStorage.setItem("lastTabXVIII", "Cover");
			localStorage.setItem("coverTabXVIIIIsActive", true);
			localStorage.setItem("authorTabXVIIIIsActive", false);
			localStorage.setItem("dedTabXVIIIIsActive", false);
			localStorage.setItem("chapterTabXVIIIIsActive", false);
