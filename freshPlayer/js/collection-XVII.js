...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabXVII = localStorage.getItem("lastTabXVII");
		if (lastTabXVII) {
			switch (lastTabXVII) {
				case "Cover":
					localStorage.setItem("coverTabXVIIIsActive", true);
					localStorage.setItem("authorTabXVIIIsActive", false);
					localStorage.setItem("dedTabXVIIIsActive", false);
					localStorage.setItem("chapterTabXVIIIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabXVIIIsActive", false);
					localStorage.setItem("authorTabXVIIIsActive", true);
					localStorage.setItem("dedTabXVIIIsActive", false);
					localStorage.setItem("chapterTabXVIIIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabXVIIIsActive", false);
					localStorage.setItem("authorTabXVIIIsActive", false);
					localStorage.setItem("dedTabXVIIIsActive", true);
					localStorage.setItem("chapterTabXVIIIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabXVIIIsActive", false);
					localStorage.setItem("dedTabXVIIIsActive", false);
					localStorage.setItem("chapterTabXVIIIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabXVII = localStorage.setItem("lastTabXVII", "Cover");
			localStorage.setItem("coverTabXVIIIsActive", true);
			localStorage.setItem("authorTabXVIIIsActive", false);
			localStorage.setItem("dedTabXVIIIsActive", false);
			localStorage.setItem("chapterTabXVIIIsActive", false);
