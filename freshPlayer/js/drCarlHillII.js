...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabDrCarlHillII = localStorage.getItem("lastTabDrCarlHillII");
		if (lastTabDrCarlHillII) {
			switch (lastTabDrCarlHillII) {
				case "Cover":
					localStorage.setItem("coverTabDrCarlHillIIIsActive", true);
					localStorage.setItem("authorTabDrCarlHillIIIsActive", false);
					localStorage.setItem("dedTabDrCarlHillIIIsActive", false);
					localStorage.setItem("chapterTabDrCarlHillIIIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabDrCarlHillIIIsActive", false);
					localStorage.setItem("authorTabDrCarlHillIIIsActive", true);
					localStorage.setItem("dedTabDrCarlHillIIIsActive", false);
					localStorage.setItem("chapterTabDrCarlHillIIIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabDrCarlHillIIIsActive", false);
					localStorage.setItem("authorTabDrCarlHillIIIsActive", false);
					localStorage.setItem("dedTabDrCarlHillIIIsActive", true);
					localStorage.setItem("chapterTabDrCarlHillIIIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabDrCarlHillIIIsActive", false);
					localStorage.setItem("dedTabDrCarlHillIIIsActive", false);
					localStorage.setItem("chapterTabDrCarlHillIIIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabDrCarlHillII = localStorage.setItem("lastTabDrCarlHillII", "Cover");
			localStorage.setItem("coverTabDrCarlHillIIIsActive", true);
			localStorage.setItem("authorTabDrCarlHillIIIsActive", false);
			localStorage.setItem("dedTabDrCarlHillIIIsActive", false);
			localStorage.setItem("chapterTabDrCarlHillIIsActive", false);
			$('#pills-trekking-tab').click();
		}
