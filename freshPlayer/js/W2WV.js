...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabW2WV = localStorage.getItem("lastTabW2WV");
		if (lastTabW2WV) {
			switch (lastTabW2WV) {
				case "Cover":
					localStorage.setItem("coverTabW2WVIsActive", true);
					localStorage.setItem("authorTabW2WVIsActive", false);
					localStorage.setItem("dedTabW2WVIsActive", false);
					localStorage.setItem("chapterTabW2WVIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabW2WVIsActive", false);
					localStorage.setItem("authorTabW2WVIsActive", true);
					localStorage.setItem("dedTabW2WVIsActive", false);
					localStorage.setItem("chapterTabW2WVIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabW2WVIsActive", false);
					localStorage.setItem("authorTabW2WVIsActive", false);
					localStorage.setItem("dedTabW2WVIsActive", true);
					localStorage.setItem("chapterTabW2WVIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabW2WVIsActive", false);
					localStorage.setItem("dedTabW2WVIsActive", false);
					localStorage.setItem("chapterTabW2WVIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabW2WV = localStorage.setItem("lastTabW2WV", "Cover");
			localStorage.setItem("coverTabW2WVIsActive", true);
			localStorage.setItem("authorTabW2WVIsActive", false);
			localStorage.setItem("dedTabW2WVIsActive", false);
			localStorage.setItem("chapterTabW2WVIsActive", false);
