...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabDrCarlHillIII = localStorage.getItem("lastTabDrCarlHillIII");
		if (lastTabDrCarlHillIII) {
			switch (lastTabDrCarlHillIII) {
				case "Cover":
					localStorage.setItem("coverTabDrCarlHillIIIIsActive", true);
					localStorage.setItem("authorTabDrCarlHillIIIIsActive", false);
					localStorage.setItem("dedTabDrCarlHillIIIIsActive", false);
					localStorage.setItem("chapterTabDrCarlHillIIIIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabDrCarlHillIIIIsActive", false);
					localStorage.setItem("authorTabDrCarlHillIIIIsActive", true);
					localStorage.setItem("dedTabDrCarlHillIIIIsActive", false);
					localStorage.setItem("chapterTabDrCarlHillIIIIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabDrCarlHillIIIIsActive", false);
					localStorage.setItem("authorTabDrCarlHillIIIIsActive", false);
					localStorage.setItem("dedTabDrCarlHillIIIIsActive", true);
					localStorage.setItem("chapterTabDrCarlHillIIIIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabDrCarlHillIIIIsActive", false);
					localStorage.setItem("dedTabDrCarlHillIIIIsActive", false);
					localStorage.setItem("chapterTabDrCarlHillIIIIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabDrCarlHillIII = localStorage.setItem("lastTabDrCarlHillIII", "Cover");
			localStorage.setItem("coverTabDrCarlHillIIIIsActive", true);
			localStorage.setItem("authorTabDrCarlHillIIIIsActive", false);
			localStorage.setItem("dedTabDrCarlHillIIIIsActive", false);
			localStorage.setItem("chapterTabDrCarlHillIIIIsActive", false);
