...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabDrCarlHillIV = localStorage.getItem("lastTabDrCarlHillIV");
		if (lastTabDrCarlHillIV) {
			switch (lastTabDrCarlHillIV) {
				case "Cover":
					localStorage.setItem("coverTabDrCarlHillIVIsActive", true);
					localStorage.setItem("authorTabDrCarlHillIVIsActive", false);
					localStorage.setItem("dedTabDrCarlHillIVIsActive", false);
					localStorage.setItem("chapterTabDrCarlHillIVIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabDrCarlHillIVIsActive", false);
					localStorage.setItem("authorTabDrCarlHillIVIsActive", true);
					localStorage.setItem("dedTabDrCarlHillIVIsActive", false);
					localStorage.setItem("chapterTabDrCarlHillIVIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabDrCarlHillIVIsActive", false);
					localStorage.setItem("authorTabDrCarlHillIVIsActive", false);
					localStorage.setItem("dedTabDrCarlHillIVIsActive", true);
					localStorage.setItem("chapterTabDrCarlHillIVIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabDrCarlHillIVIsActive", false);
					localStorage.setItem("dedTabDrCarlHillIVIsActive", false);
					localStorage.setItem("chapterTabDrCarlHillIVIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabDrCarlHillIV = localStorage.setItem("lastTabDrCarlHillIV", "Cover");
			localStorage.setItem("coverTabDrCarlHillIVIsActive", true);
			localStorage.setItem("authorTabDrCarlHillIVIsActive", false);
			localStorage.setItem("dedTabDrCarlHillIVIsActive", false);
			localStorage.setItem("chapterTabDrCarlHillIVIsActive", false);
