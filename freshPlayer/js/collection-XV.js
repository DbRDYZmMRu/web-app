...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabXV = localStorage.getItem("lastTabXV");
		if (lastTabXV) {
			switch (lastTabXV) {
				case "Cover":
					localStorage.setItem("coverTabXVIsActive", true);
					localStorage.setItem("authorTabXVIsActive", false);
					localStorage.setItem("dedTabXVIsActive", false);
					localStorage.setItem("chapterTabXVIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabXVIsActive", false);
					localStorage.setItem("authorTabXVIsActive", true);
					localStorage.setItem("dedTabXVIsActive", false);
					localStorage.setItem("chapterTabXVIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabXVIsActive", false);
					localStorage.setItem("authorTabXVIsActive", false);
					localStorage.setItem("dedTabXVIsActive", true);
					localStorage.setItem("chapterTabXVIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabXVIsActive", false);
					localStorage.setItem("dedTabXVIsActive", false);
					localStorage.setItem("chapterTabXVIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabXV = localStorage.setItem("lastTabXV", "Cover");
			localStorage.setItem("coverTabXVIsActive", true);
			localStorage.setItem("authorTabXVIsActive", false);
			localStorage.setItem("dedTabXVIsActive", false);
			localStorage.setItem("chapterTabXVIsActive", false);
