...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabW2WI = localStorage.getItem("lastTabW2WI");
		if (lastTabW2WI) {
			switch (lastTabW2WI) {
				case "Cover":
					localStorage.setItem("coverTabW2WIIsActive", true);
					localStorage.setItem("authorTabW2WIIsActive", false);
					localStorage.setItem("dedTabW2WIIsActive", false);
					localStorage.setItem("chapterTabW2WIIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabW2WIIsActive", false);
					localStorage.setItem("authorTabW2WIIsActive", true);
					localStorage.setItem("dedTabW2WIIsActive", false);
					localStorage.setItem("chapterTabW2WIIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabW2WIIsActive", false);
					localStorage.setItem("authorTabW2WIIsActive", false);
					localStorage.setItem("dedTabW2WIIsActive", true);
					localStorage.setItem("chapterTabW2WIIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabW2WIIsActive", false);
					localStorage.setItem("dedTabW2WIIsActive", false);
					localStorage.setItem("chapterTabW2WIIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabW2WI = localStorage.setItem("lastTabW2WI", "Cover");
			localStorage.setItem("coverTabW2WIIsActive", true);
			localStorage.setItem("authorTabW2WIIsActive", false);
			localStorage.setItem("dedTabW2WIIsActive", false);
			localStorage.setItem("chapterTabW2WIIsActive", false);
