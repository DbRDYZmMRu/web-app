...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabXX = localStorage.getItem("lastTabXX");
		if (lastTabXX) {
			switch (lastTabXX) {
				case "Cover":
					localStorage.setItem("coverTabXXIsActive", true);
					localStorage.setItem("authorTabXXIsActive", false);
					localStorage.setItem("dedTabXXIsActive", false);
					localStorage.setItem("chapterTabXXIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabXXIsActive", false);
					localStorage.setItem("authorTabXXIsActive", true);
					localStorage.setItem("dedTabXXIsActive", false);
					localStorage.setItem("chapterTabXXIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabXXIsActive", false);
					localStorage.setItem("authorTabXXIsActive", false);
					localStorage.setItem("dedTabXXIsActive", true);
					localStorage.setItem("chapterTabXXIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabXXIsActive", false);
					localStorage.setItem("dedTabXXIsActive", false);
					localStorage.setItem("chapterTabXXIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabXX = localStorage.setItem("lastTabXX", "Cover");
			localStorage.setItem("coverTabXXIsActive", true);
			localStorage.setItem("authorTabXXIsActive", false);
			localStorage.setItem("dedTabXXIsActive", false);
			localStorage.setItem("chapterTabXXIsActive", false);
