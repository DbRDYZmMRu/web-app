...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabXIX = localStorage.getItem("lastTabXIX");
		if (lastTabXIX) {
			switch (lastTabXIX) {
				case "Cover":
					localStorage.setItem("coverTabXIXIsActive", true);
					localStorage.setItem("authorTabXIXIsActive", false);
					localStorage.setItem("dedTabXIXIsActive", false);
					localStorage.setItem("chapterTabXIXIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabXIXIsActive", false);
					localStorage.setItem("authorTabXIXIsActive", true);
					localStorage.setItem("dedTabXIXIsActive", false);
					localStorage.setItem("chapterTabXIXIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabXIXIsActive", false);
					localStorage.setItem("authorTabXIXIsActive", false);
					localStorage.setItem("dedTabXIXIsActive", true);
					localStorage.setItem("chapterTabXIXIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabXIXIsActive", false);
					localStorage.setItem("dedTabXIXIsActive", false);
					localStorage.setItem("chapterTabXIXIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabXIX = localStorage.setItem("lastTabXIX", "Cover");
			localStorage.setItem("coverTabXIXIsActive", true);
			localStorage.setItem("authorTabXIXIsActive", false);
			localStorage.setItem("dedTabXIXIsActive", false);
			localStorage.setItem("chapterTabXIXIsActive", false);
