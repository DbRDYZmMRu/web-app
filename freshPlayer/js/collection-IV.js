...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabIV = localStorage.getItem("lastTabIV");
		if (lastTabIV) {
			switch (lastTabIV) {
				case "Cover":
					localStorage.setItem("coverTabIVIsActive", true);
					localStorage.setItem("authorTabIVIsActive", false);
					localStorage.setItem("dedTabIVIsActive", false);
					localStorage.setItem("chapterTabIVIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabIVIsActive", false);
					localStorage.setItem("authorTabIVIsActive", true);
					localStorage.setItem("dedTabIVIsActive", false);
					localStorage.setItem("chapterTabIVIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabIVIsActive", false);
					localStorage.setItem("authorTabIVIsActive", false);
					localStorage.setItem("dedTabIVIsActive", true);
					localStorage.setItem("chapterTabIVIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabIVIsActive", false);
					localStorage.setItem("dedTabIVIsActive", false);
					localStorage.setItem("chapterTabIVIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabIV = localStorage.setItem("lastTabIV", "Cover");
			localStorage.setItem("coverTabIVIsActive", true);
			localStorage.setItem("authorTabIVIsActive", false);
			localStorage.setItem("dedTabIVIsActive", false);
			localStorage.setItem("chapterTabIVIsActive", false);
