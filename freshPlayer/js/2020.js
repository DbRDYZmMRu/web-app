...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTab2020 = localStorage.getItem("lastTab2020");
		if (lastTab2020) {
			switch (lastTab2020) {
				case "Cover":
					localStorage.setItem("coverTab2020IsActive", true);
					localStorage.setItem("authorTab2020IsActive", false);
					localStorage.setItem("dedTab2020IsActive", false);
					localStorage.setItem("chapterTab2020IsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTab2020IsActive", false);
					localStorage.setItem("authorTab2020IsActive", true);
					localStorage.setItem("dedTab2020IsActive", false);
					localStorage.setItem("chapterTab2020IsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTab2020IsActive", false);
					localStorage.setItem("authorTab2020IsActive", false);
					localStorage.setItem("dedTab2020IsActive", true);
					localStorage.setItem("chapterTab2020IsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTab2020IsActive", false);
					localStorage.setItem("dedTab2020IsActive", false);
					localStorage.setItem("chapterTab2020IsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTab2020 = localStorage.setItem("lastTab2020", "Cover");
			localStorage.setItem("coverTab2020IsActive", true);
			localStorage.setItem("authorTab2020IsActive", false);
			localStorage.setItem("dedTab2020IsActive", false);
			localStorage.setItem("chapterTab2020IsActive", false);
