...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabXIii = localStorage.getItem("lastTabXIii");
		if (lastTabXIii) {
			switch (lastTabXIii) {
				case "Cover":
					localStorage.setItem("coverTabXIiiIsActive", true);
					localStorage.setItem("authorTabXIiiIsActive", false);
					localStorage.setItem("dedTabXIiiIsActive", false);
					localStorage.setItem("chapterTabXIiiIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabXIiiIsActive", false);
					localStorage.setItem("authorTabXIiiIsActive", true);
					localStorage.setItem("dedTabXIiiIsActive", false);
					localStorage.setItem("chapterTabXIiiIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabXIiiIsActive", false);
					localStorage.setItem("authorTabXIiiIsActive", false);
					localStorage.setItem("dedTabXIiiIsActive", true);
					localStorage.setItem("chapterTabXIiiIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabXIiiIsActive", false);
					localStorage.setItem("dedTabXIiiIsActive", false);
					localStorage.setItem("chapterTabXIiiIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabXIii = localStorage.setItem("lastTabXIii", "Cover");
			localStorage.setItem("coverTabXIiiIsActive", true);
			localStorage.setItem("authorTabXIiiIsActive", false);
			localStorage.setItem("dedTabXIiiIsActive", false);
			localStorage.setItem("chapterTabXIiiIsActive", false);
