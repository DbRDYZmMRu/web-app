...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabIIIv2 = localStorage.getItem("lastTabIIIv2");
		if (lastTabIIIv2) {
			switch (lastTabIIIv2) {
				case "Cover":
					...
					localStorage.setItem("chapterTabIIIv2IsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabIIIv2IsActive", false);
					localStorage.setItem("authorTabIIIv2IsActive", true);
					localStorage.setItem("dedTabIIIv2IsActive", false);
					localStorage.setItem("chapterTabIIIv2IsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabIIIv2IsActive", false);
					localStorage.setItem("authorTabIIIv2IsActive", false);
					localStorage.setItem("dedTabIIIv2IsActive", true);
					localStorage.setItem("chapterTabIIIv2IsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabIIIv2IsActive", false);
					localStorage.setItem("dedTabIIIv2IsActive", false);
					localStorage.setItem("chapterTabIIIv2IsActive", true);
