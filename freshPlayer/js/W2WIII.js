...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabW2WIII = localStorage.getItem("lastTabW2WIII");
		if (lastTabW2WIII) {
			switch (lastTabW2WIII) {
				case "Cover":
					localStorage.setItem("coverTabW2WIIIIsActive", true);
					localStorage.setItem("authorTabW2WIIIIsActive", false);
					localStorage.setItem("dedTabW2WIIIIsActive", false);
					localStorage.setItem("chapterTabW2WIIIIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabW2WIIIIsActive", false);
					localStorage.setItem("authorTabW2WIIIIsActive", true);
					localStorage.setItem("dedTabW2WIIIIsActive", false);
					localStorage.setItem("chapterTabW2WIIIIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabW2WIIIIsActive", false);
					localStorage.setItem("authorTabW2WIIIIsActive", false);
					localStorage.setItem("dedTabW2WIIIIsActive", true);
					localStorage.setItem("chapterTabW2WIIIIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabW2WIIIIsActive", false);
					localStorage.setItem("dedTabW2WIIIIsActive", false);
					localStorage.setItem("chapterTabW2WIIIIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabW2WIII = localStorage.setItem("lastTabW2WIII", "Cover");
			localStorage.setItem("coverTabW2WIIIIsActive", true);
			localStorage.setItem("authorTabW2WIIIIsActive", false);
			localStorage.setItem("dedTabW2WIIIIsActive", false);
			localStorage.setItem("chapterTabW2WIIIIsActive", false);
