...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabXIV = localStorage.getItem("lastTabXIV");
		if (lastTabXIV) {
			switch (lastTabXIV) {
				case "Cover":
					localStorage.setItem("coverTabXIVIsActive", true);
					localStorage.setItem("authorTabXIVIsActive", false);
					localStorage.setItem("dedTabXIVIsActive", false);
					localStorage.setItem("chapterTabXIVIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabXIVIsActive", false);
					localStorage.setItem("authorTabXIVIsActive", true);
					localStorage.setItem("dedTabXIVIsActive", false);
					localStorage.setItem("chapterTabXIVIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabXIVIsActive", false);
					localStorage.setItem("authorTabXIVIsActive", false);
					localStorage.setItem("dedTabXIVIsActive", true);
					localStorage.setItem("chapterTabXIVIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabXIVIsActive", false);
					localStorage.setItem("dedTabXIVIsActive", false);
					localStorage.setItem("chapterTabXIVIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabXIV = localStorage.setItem("lastTabXIV", "Cover");
			localStorage.setItem("coverTabXIVIsActive", true);
			localStorage.setItem("authorTabXIVIsActive", false);
			localStorage.setItem("dedTabXIVIsActive", false);
			localStorage.setItem("chapterTabXIVIsActive", false);
