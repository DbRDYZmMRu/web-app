...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabDrCarlHillV = localStorage.getItem("lastTabDrCarlHillV");
		if (lastTabDrCarlHillV) {
			switch (lastTabDrCarlHillV) {
				case "Cover":
					localStorage.setItem("coverTabDrCarlHillVIsActive", true);
					localStorage.setItem("authorTabDrCarlHillVIsActive", false);
					localStorage.setItem("dedTabDrCarlHillVIsActive", false);
					localStorage.setItem("chapterTabDrCarlHillVIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabDrCarlHillVIsActive", false);
					localStorage.setItem("authorTabDrCarlHillVIsActive", true);
					localStorage.setItem("dedTabDrCarlHillVIsActive", false);
					localStorage.setItem("chapterTabDrCarlHillVIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabDrCarlHillVIsActive", false);
					localStorage.setItem("authorTabDrCarlHillVIsActive", false);
					localStorage.setItem("dedTabDrCarlHillVIsActive", true);
					localStorage.setItem("chapterTabDrCarlHillVIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabDrCarlHillVIsActive", false);
					localStorage.setItem("dedTabDrCarlHillVIsActive", false);
					localStorage.setItem("chapterTabDrCarlHillVIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabDrCarlHillV = localStorage.setItem("lastTabDrCarlHillV", "Cover");
			localStorage.setItem("coverTabDrCarlHillVIsActive", true);
			localStorage.setItem("authorTabDrCarlHillVIsActive", false);
			localStorage.setItem("dedTabDrCarlHillVIsActive", false);
			localStorage.setItem("chapterTabDrCarlHillVIsActive", false);
